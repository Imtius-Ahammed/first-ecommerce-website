...
const Register = () => {
    ...
    return (
      ...
      <div className='px-3'>
                        <button className='flex justify-center  mt-2' onClick={()=>document.getElementById('register').showModal()}>Don't have an account? <span className='font-bold ml-2 underline'>Register</span></button>
